...
@section('header')
<header class="text-white header h-fullscreen pb-80" style="background-image: url('{{ Storage::url($post->image) }}');" data-overlay="9">
    <div class="container text-center">
        <div class="row h-100">
            <div class="mx-auto col-lg-8 align-self-center">
                <p class="opacity-70 text-uppercase small ls-1">

                {{$post->category->name}}
                </p>
                <h1 class="mb-8 display-4 mt-7">
                    {{$post->title}}
                </h1>
                <p><span class="mr-1 opacity-70">By</span> <a class="text-white" href="#">
...
<script>
    ...
    *  LEARN WHY DEFINING THESE VARIABLES IS IMPORTANT: https://disqus.com/admin/universalcode/#configuration-variables    */
    ...
    s.src = 'https://saas-blog-9kqlblyx1f.disqus.com/embed.js';
